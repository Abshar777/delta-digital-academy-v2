...
const SEO_TOPICS = [
  { label: "Introduction to Search Engine Optimization", icon: <FaSearch className="w-5 h-5" /> },
...
const FLEXIBLE_FEATURES = [
  { label: "Classroom Training in Dubai", icon: <FaChalkboardTeacher className="w-6 h-6" /> },
  { label: "Live Online Sessions", icon: <FaLaptop className="w-6 h-6" /> },
  { label: "Weekend Batches", icon: <FaCalendarAlt className="w-6 h-6" /> },
  { label: "Flexible Timings", icon: <FaClock className="w-6 h-6" /> },
  { label: "Practical Assignments", icon: <FaTasks className="w-6 h-6" /> },
  { label: "Certification Support", icon: <FaCertificate className="w-6 h-6" /> },
];
...
const CAREER_ROLES = [
  { title: "SEO Executive", icon: <FaSearch className="w-6 h-6" /> },
  { title: "SEO Analyst", icon: <FaChartLine className="w-6 h-6" /> },
  { title: "Digital Marketing Specialist", icon: <FaGoogle className="w-6 h-6" /> },
  { title: "Content Strategist", icon: <FaPen className="w-6 h-6" /> },
  { title: "SEO Freelancer", icon: <FaLaptop className="w-6 h-6" /> },
  { title: "Website Optimization Consultant", icon: <FaBriefcase className="w-6 h-6" /> },
];
    ...
    <div ref={heroRef} className="w-full bg-foreground">
      ...
      <div className="w-full bg-background grid-bg rounded-b-[4rem] flex flex-col justify-center items-center min-h-screen px-6 py-32 text-center relative overflow-hidden">
        <motion.p
          ...
          className="hero-text bg-primary mb-4 py-2 px-6 rounded-full text-sm font-semibold font-poppins"
        >
          SEO Course in Dubai
        </motion.p>
        ...
        <div className="flex md:flex-row flex-col mt-10 gap-4 justify-center items-center">
          <div className="hero-btn">
            <Button
              ...
              className="rounded-full hover:bg-foreground w-full hover:text-background hover:shadow-[1px_1px_0_0_#000] transition-all ease-in font-semibold font-poppins text-foreground border-2 border-foreground shadow-[3px_3px_0_0_#000]"
            >
      ...
      <div className="bg-foreground pt-4">
        <section className="bg-background grid-bg md:rounded-t-[4rem] rounded-t-[3rem] md:px-20 px-6 py-20 md:py-28">
          <div className="max-w-7xl mx-auto">
            <div className="section-title flex flex-col items-center text-center gap-3 mb-16">
              <p className="w-fit bg-primary px-6 rounded-full text-foreground text-sm py-2 font-semibold font-poppins">
                Why Choose Us
              </p>
              <h2 className="md:text-5xl text-4xl font-black text-[#171717] tracking-tighter leading-none capitalize">
                Why Choose Delta Digital Academy<br />for SEO Training?
              </h2>
            ...
            <div className="topics-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {SEO_TOPICS.map((topic, i) => (
                <motion.div
                  key={i}
                  whileHover={{ y: -8, transition: { duration: 0.25 } }}
                  className="topic-card bg-white border-2 border-[#171717] shadow-[4px_4px_0_0_#000] rounded-2xl p-5 flex flex-col gap-3 items-start"
                >
                  <div className="bg-primary p-2 rounded-xl border border-[#171717]">
                    {topic.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="section-title flex flex-col items-center text-center gap-3 mb-16">
              ...
              <h2 className="md:text-5xl text-4xl font-black text-[#171717] tracking-tighter leading-none capitalize">
                ...
                <span className="text-primary color-flicker-text">Beginners</span> &amp; Professionals
              </h2>
              <p className="text-[#171717]/70 max-w-2xl font-poppins text-sm md:text-base">
            ...
            <div className="features-grid grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-8">
              {FLEXIBLE_FEATURES.map((f, i) => (
                <motion.div
                  key={i}
                  whileHover={{ y: -8, transition: { duration: 0.25 } }}
                  className="feature-card bg-white border-2 border-[#171717] shadow-[4px_4px_0_0_#000] rounded-2xl p-6 flex flex-col gap-4"
                >
                  <div className="bg-primary p-3 rounded-xl w-fit border border-[#171717]">
                    {f.icon}
                  </div>
                  <p className="font-bold font-poppins text-[#171717] text-sm md:text-base">
                    {f.label}
                  </p>
                </motion.div>
              ))}
      ...
      {/* ── WHY SEO MATTERS ── */}
      <div className="bg-foreground pt-4">
        <section className="bg-[#C1F42D] border-y-4 border-[#171717] md:px-20 px-6 py-20 md:py-28">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="section-title">
              ...
              <h2 className="md:text-5xl text-4xl font-black text-[#171717] tracking-tighter leading-none capitalize mb-6">
                Why SEO Courses in Dubai Is Important in Digital Marketing
              </h2>
              <p className="text-[#171717]/80 font-poppins text-sm md:text-base">
            ...
            <div className="benefits-list flex flex-col gap-4">
              {SEO_BENEFITS.map((b, i) => (
                <motion.div
                  key={i}
                  whileHover={{ x: 6, transition: { duration: 0.2 } }}
                  className="benefit-item flex items-center gap-4 bg-white border-2 border-[#171717] shadow-[4px_4px_0_0_#171717] rounded-2xl px-6 py-4"
                >
              ...
              <p className="text-xs font-semibold font-poppins text-[#171717]/70 mt-2 pl-1">
                This makes SEO one of the most valuable skills offered through professional
        ...
        <section className="bg-background grid-bg md:rounded-t-[4rem] rounded-t-[3rem] md:px-20 px-6 py-20 md:py-28">
          <div className="max-w-7xl mx-auto">
            <div className="section-title flex flex-col items-center text-center gap-3 mb-16">
              ...
              <h2 className="md:text-5xl text-4xl font-black text-[#171717] tracking-tighter leading-none capitalize">
                Career Opportunities After<br />SEO Courses Training
              </h2>
              <p className="text-[#171717]/70 max-w-2xl font-poppins text-sm md:text-base">
            ...
            <div className="roles-grid grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-8">
              {CAREER_ROLES.map((role, i) => (
                <motion.div
                  key={i}
                  whileHover={{ y: -8, transition: { duration: 0.25 } }}
                  className="role-card bg-white border-2 border-[#171717] shadow-[4px_4px_0_0_#000] rounded-2xl p-6 flex flex-col gap-4"
                >
                  <div className="bg-primary p-3 rounded-xl w-fit border border-[#171717]">
                    {role.icon}
                  </div>
      ...
      <div className="bg-foreground pt-4 md:p-4 p-2">
        <section className="cta-section bg-[#C1F42D] border-4 border-[#171717] rounded-2xl md:py-24 py-16 px-6 relative overflow-hidden">
          {/* Decorative */}
          <div className="absolute top-8 left-8 w-16 h-16 border-4 border-[#171717] bg-white rounded-xl hidden md:flex items-center justify-center font-black text-2xl shadow-[4px_4px_0_0_#171717]">
            SEO
          </div>
          <div className="absolute bottom-8 right-8 w-28 h-10 bg-[#171717] text-white hidden md:flex items-center justify-center font-black uppercase tracking-widest text-xs shadow-[4px_4px_0_0_white] rounded-lg -rotate-6">
            Enroll Now
          </div>
