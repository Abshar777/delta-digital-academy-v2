...
const ApplyModal: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const scriptUrl =
      "https://script.google.com/macros/s/AKfycbzGU4JIwBhXJ71kqaBX1avg_FbqedLRQGC1y4-1-uf2cnWhP7XiahzbMlEEYmHS_jKy/exec";
                  ...
                  <div className="grid grid-cols-3 gap-3 md:gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#F5F5F5] border-4 border-[#171717] h-16 p-4 font-bold focus:bg-[#C1F42D] focus:outline-none"
                      >
