...
const AlumniCard: React.FC<AlumniCardProps> = ({ 
  ...
  return (
    <div className="bg-white border-4 border-[#171717] shadow-[6px_6px_0px_0px_#000] overflow-hidden flex flex-col md:min-w-[320px] transition-all hover:scale-[.98] hover:shadow-[12px_12px_0px_0px_#000] duration-300">
      <div className="md:h-64   h-48 relative overflow-hidden flex items-end justify-center" style={{ backgroundColor: bgColor }}>
        <img 
          src={image} 
          alt={name} 
      ...
      <div className="p-6 text-center border-t-4 border-[#171717]">
        <h4 className="md:text-2xl  text-lg font-black text-[#171717] mb-4 uppercase">{name}</h4>
